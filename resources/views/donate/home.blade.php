...
<div class="container my-16 mx-auto w-1/2">
    ...
    <p class="mb-2 font-bold">However, this website does have expenses that need to be covered to remain operational. If
        you can afford to do so, any financial help to the support staff for this app is greatly appreciated.</p>
    <p class="mb-2 font-bold">As a thank you for your donation, we will also give you a cool pin for your avatar to show
    ...
    <table class="table-fixed w-full">
        <tbody>
            <tr>
                ...
                <td class="w-3/4">
                    <input type="text" class="w-full" name="name" id="name" aria-describedby="helpId" placeholder="Jane Doe">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="number" class="w-full" name="cost" id="cost" aria-describedby="helpId" value="5" min="0">
                </td>
            </tr>
            <tr>
                <td>
            ...
            stripe.createToken(cardElement).then(function (result) {
                if (result.error) {
                    ...
                    axios.post('{{route("process-donation")}}', {
                        ...
                        if (response.status) {
                            window.location.replace('{{route("successful-donation")}}');
                        } else {
                            alert(
